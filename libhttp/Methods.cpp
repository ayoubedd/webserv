...
libhttp::Response setResponse(libhttp::Response &response, int fd, size_t bytesToServe, std::vector<char > buffer)
{
    response.fd = fd;
...
std::pair<libhttp::Methods::error,libhttp::Response > libhttp::Get(libhttp::Request &request,std::string path)
{
